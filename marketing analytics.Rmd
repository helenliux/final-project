...
```
We create segments based on demographic characteristics like sex and ethnicity. Therefore we create seven segments totally. We use the best model mentioned above to predict the mean approval rating. We set a threshold and select the segments whose mean approval rating is above 0.5.There are four group left and they are male and Not Hispanic or Latino, male and Not applicable, female and Not Hispanic or Latino, Not applicable and not applicable. These groups have high approval ratings. There are several applications of the predicting ratings. For banks, they should target these four groups because these customers are more likely to get loans. For financial intermediaries that help customers to acquire loans, they should also target these four groups and therefore they d
