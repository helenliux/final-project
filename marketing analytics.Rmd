...
In our model, there are significant customer segments based on demographics and non-demographics. The base group for our selected model is under following conditions: preapproval is requested, loan was secured by first lien, loan was for home purchase, loan was not originated or sold in calendar year covered by register, applicant is male and hispanic or latino. We found there are significant segments in preapproval, lien status, loan purpose, purchaser type, applicant sex and applicant ethnicity, as their p-value are less than 0.05. For all applicants, if the income increases 1000 dollars, the probability of getting approved incrases 0.01%.
