...
group_by(applicant_sex_name,applicant_ethnicity_name,lien_status,preapproval,loan_purpose,purchaser_type)%>%
summarize(AppliantIncome=mean(applicant_income_000s),LoanAmount=mean(loan_amount_000s))
customerSegments
